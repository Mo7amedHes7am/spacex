...
class QuizMayPage extends StatefulWidget {
  const QuizMayPage({super.key});

  @override
  State<QuizMayPage> createState() => _QuizMayPageState();
}

class _QuizMayPageState extends State<QuizMayPage> {
  ...
  void initState() {
    ...
    quiz = QuizModel(
        id: '011',
        title: "May 2024 Magnetic Storm",
        description: "Take This Quiz To Get Certified",
        imgurl: AssetImage('assets/puzzle.jpg'),
        type: 'quiz',
        questions: {
          'What caused the geomagnetic storm in May 2024?':['A) A solar flare','B) Coronal Mass Ejections (CMEs) from the Sun','C) Earth’s shifting magnetic poles', 'D) A supernova explosion'],
          'What is space weather?':['A) Radiation from space that impacts astronauts and technology on Earth.','B) Weather conditions on Mars.','C) Atmospheric storms in Earth\'s atmosphere.', 'D) Oceanic currents influenced by solar flares.'],
        },
        answers: {
          'What caused the geomagnetic storm in May 2024?':1,
          'What is space weather?':0
        },
        points: [2000], time: 5000, passed: 1000, took: [], focusedtype: '', focusedid: '');
